  ...
  const bookings = async () => {
    try {
      const response = await axios.get(
        `${process.env.REACT_APP_API}/api/v1/gettickets`,
        {
          params: {
  ...
  return (
    <div>
      ...
      {tickets.length !== 0 ? (
        ...
        >
          <img
            src="https://thumbs.dreamstime.com/b/sitting-child-sad-icon-element-mobile-concept-web-apps-glyph-can-be-used-white-background-130425111.jpg"
            alt="NoBus"
