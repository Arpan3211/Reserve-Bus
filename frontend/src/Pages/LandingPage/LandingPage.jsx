...
function LandingPage() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await axios.get(
        `${process.env.REACT_APP_API}/api/v1/tripsbyquery`,
        {
          params: {
  ...
  const handleDistricts = async () => {
    try {
      const response = await axios.get(
        `${process.env.REACT_APP_API}/api/v1/states`
      );
  ...
  useEffect(() => {
    window.alert(
      "Kindly choose the journey from Anantapur to Chittoor and date as 22-06-2023 to see full functionality!"
    );
    handleDistricts();
  }, []);
    ...
    <>
      ...
      >
        <Col className="col-md-6 ">
          ...
          >
            <div
              className="d-flex flex-column flex-sm-row justify-content-between mb-4"
              style={{
                display: "flex",
                marginBottom: "50px",
                justifyContent: "center",
            ...
            >
              <FormGroup
                style={{
                  ...
                  borderRadius: "5px",
                  backgroundImage:
                    "linear-gradient(to bottom, #ffffff, #ffffff), linear-gradient(to bottom, #f9f9f9, #f9f9f9)",
                  backgroundRepeat: "no-repeat, repeat-y",
                  backgroundSize: "0 0, 100% 40px",
                  backgroundPosition: "right 10px top 50%, 0 0",
                }}
                className="d-flex flex-column justify-content-start flex-grow-1 me-sm-2 bg-body-tertiary border border-dark "
              >
                <Label
                  for="source"
              ...
              <FormGroup
                ...
                className="d-flex flex-column justify-content-start mx-2 flex-grow-1 me-sm-2 bg-body-tertiary border border-dark"
              >
                <Label
                  className="text-muted"
                  for="destination"
            ...
            <Button
              type="submit"
              className="btn btn-lg mt-3 d-flex justify-content-center border border-dark border-2"
              style={{ fontWeight: "bold", backgroundColor: "#FF5733" }}
      ...
      >
        Book your journey with world's largest bus platform
      </p>
              ...
              <div className="col-md-4 mt-2">
                <div className="card shadow">
                  <div className="card-body">
                    ...
                    <p className="mt-3 text-muted">
                      Awesome service, Always a best time with reserve. Thankyou
                      Reserve!.
                    </p>
                  </div>
                </div>
